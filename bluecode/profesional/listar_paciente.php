...
<body>
    ...
    <div class="container">
        ...
        <form action="listar_paciente.php" method="GET" class="search-form">
        ...
        <table>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href='eliminar_pac.php?idpaciente={$row['idpaciente']}'><i class='fas fa-trash-alt'></i></a> <a href='update_pac.php?idpaciente={$row['idpaciente']}'><i class='fas fa-pencil-alt'></i></a></td>";
                    echo "</tr>";
                }
